                                                ...
                                                <form id="form" method="{{isset($item) ? 'POST' : 'POST'}}" to="{{url()->current()}}" url="{{url()->current()}}" class="w-100">
                                                    ...
                                                    <div class="form theme-form">
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input id="first_name" class="form-control" type="text" name="first_name" placeholder="{{__('first name')}}">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="mb-3">
                                                                    <label for="last_name">{{__('last name')}}<span class="text-danger">*</span></label>
                                                                    <input class="form-control" id="last_name" type="text" name="last_name" placeholder="{{__('last name')}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-3">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input class="form-control" id="phone" type="text" name="mobile" placeholder="{{__('phone')}}">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="mb-3 mt-4 d-flex gap-3 checkbox-checked">
                                                                    <label class="form-label" for="">{{ __('gender') }}<span class="text-danger">*</span></label>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" id="male" type="radio" value="male" name="gender">
                                                                        <label class="form-check-label mb-0" for="male">{{ __('male') }} </label>
                                                                    </div>
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" id="female" value="female" type="radio" name="gender" checked="">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                            <div class="">
                                                                <button class="btn btn-primary" type="submit" id="btn_submit"> {{__('save')}} </button>
                                                            </div>
                                                            </div>
                                                        </div>
                                                    </div>

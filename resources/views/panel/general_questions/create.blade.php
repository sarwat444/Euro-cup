...
if(isset($item) && isset($item['answers']) &&  count($item['answers']) > 0){
                    ...
                    <div class="card-body">
                        <form id="form" method="{{isset($item) ? 'POST' : 'POST'}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 input-box">
                                    <input type="hidden" value="{{ isset($item) && $item['answers'] && count($item['answers']) > 0 ? $item['answers'][0]->id : '' }}" name="answer_id">

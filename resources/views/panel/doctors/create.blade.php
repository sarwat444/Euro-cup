                            ...
                            <div class="form theme-form">
                                ...
                                <div class="row">
                                    <div class="col-4 input-box">
                                        ...
                                        <div class="form-group">
                                            <input class="p-2 form-control" name="country_en" value="{{ isset($item) && $item->doctorInfo?->translate('en') ? $item->doctorInfo->translate('en')->country :'' }}" placeholder="{{ __('country english') }}">
                                        </div>
                                    </div>
                                    <div class="col-4 input-box">
                                        <label class="font-size-14 text-black fw-medium mb-2">{{ __('country arabic') }}</label>
                                        <div class="form-group">
                                            <input class="p-2 form-control" name="country_ar" value="{{ isset($item) && $item->doctorInfo?->translate('ar') ? $item->doctorInfo->translate('ar')->country :'' }}" placeholder="{{ __('country arabic') }}">
                                        </div>
                                    </div>
                                    <div class="col-4 input-box">
                                        <label class="font-size-14 text-black fw-medium mb-2">{{ __('country french') }}</label>
                                        <div class="form-group">
                                            <input class="p-2 form-control" name="country_fr" value="{{ isset($item) && $item->doctorInfo?->translate('fr') ? $item->doctorInfo->translate('fr')->country :'' }}" placeholder="{{ __('country french') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-4 input-box">
                                        ...
                                        <div class="form-group">
                                            <input class="p-2 form-control" name="city_en" value="{{ isset($item) && $item->doctorInfo?->translate('en') ? $item->doctorInfo->translate('en')->city :'' }}" placeholder="{{ __('city english') }}">
                                        </div>
                                    </div>
                                    <div class="col-4 input-box">
                                        <label class="font-size-14 text-black fw-medium mb-2">{{ __('city arabic') }}</label>
                                        <div class="form-group">
                                            <input class="p-2 form-control" name="city_ar" value="{{ isset($item) && $item->doctorInfo?->translate('ar') ? $item->doctorInfo->translate('ar')->city :'' }}" placeholder="{{ __('city arabic') }}">
                                        </div>
                                    </div>
                                    <div class="col-4 input-box">
                                        <label class="font-size-14 text-black fw-medium mb-2">{{ __('city french') }}</label>
                                        <div class="form-group">
                                            <input class="p-2 form-control" name="city_fr" value="{{ isset($item) && $item->doctorInfo?->translate('fr') ? $item->doctorInfo->translate('fr')->city :'' }}" placeholder="{{ __('city french') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-4 input-box">
                                        ...
                                        <div class="form-group">
                                            <input class="p-2 form-control" name="languages_en" value="{{ isset($item) && $item->doctorInfo?->translate('en') ? $item->doctorInfo->translate('en')->languages :'' }}" placeholder="{{ __('languages english') }}">
                                        </div>
                                    </div>
                                    <div class="col-4 input-box">
                                        <label class="font-size-14 text-black fw-medium mb-2">{{ __('languages arabic') }}</label>
                                        <div class="form-group">
                                            <input class="p-2 form-control" name="languages_ar" value="{{ isset($item) && $item->doctorInfo?->translate('ar') ? $item->doctorInfo->translate('ar')->languages :'' }}" placeholder="{{ __('languages arabic') }}">
                                        </div>
                                    </div>
                                    <div class="col-4 input-box">
                                        <label class="font-size-14 text-black fw-medium mb-2">{{ __('languages french') }}</label>
                                        <div class="form-group">
                                            <input class="p-2 form-control" name="languages_fr" value="{{ isset($item) && $item->doctorInfo?->translate('fr') ? $item->doctorInfo->translate('fr')->languages :'' }}" placeholder="{{ __('languages french') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="customState-wizard" name="specialize_id">
                                                ...
                                                @foreach($specializes as $specialize)
                                                    <option
                                                        value="{{ $specialize->id }}" {{ isset($item) && $item->doctorInfo?->specialize_id == $specialize->id ? 'selected' : '' }}> {{ $specialize->name }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="alternative_medicine_price" type="number" name="alternative_medicine_price"
                                                   placeholder="{{__('alternative medicine price')}}" value="{{ isset($item) ? $item->doctorInfo?->alternative_medicine_price : '' }}">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-3 pt-4">
                                        ...
                                        <input type="checkbox" name="has_urgent" {{ isset($item) && $item->doctorInfo?->has_urgent == 1 ? 'checked' : '' }}>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-3">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="min_price" type="number" name="min_price"
                                                   placeholder="{{__('min price')}}" value="{{ isset($item) ? $item->doctorInfo?->min_price : '' }}">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" id="max_price" type="number" name="max_price"
                                                   placeholder="{{__('max price')}}" value="{{ isset($item) ? $item->doctorInfo?->max_price : '' }}">
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-3">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="number" id="urgent_amount"
                                                   name="urgent_amount" placeholder="{{__('urgent amount')}}"  value="{{ isset($item) ? $item->doctorInfo?->urgent_amount : '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row mt-2">
                                    <div class="col-4 input-box">
                                        ...
                                        <div class="form-group">
                                            <textarea class="p-2 form-control" name="details_en"  rows="10" cols="80" placeholder="{{ __('details english') }}">{{ isset($item) && $item->doctorInfo?->translate('en') ? $item->doctorInfo->translate('en')->details :'' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-4 input-box">
                                        <label class="font-size-14 text-black fw-medium mb-2">{{ __('details arabic') }}</label>
                                        <div class="form-group">
                                            <textarea class="p-2 form-control" name="details_ar"  rows="10" cols="80" placeholder="{{ __('details arabic') }}">{{ isset($item) && $item->doctorInfo?->translate('ar') ? $item->doctorInfo->translate('ar')->details :'' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-4 input-box">
                                        <label class="font-size-14 text-black fw-medium mb-2">{{ __('details french') }}</label>
                                        <div class="form-group">
                                            <textarea class="p-2 form-control" name="details_fr"  rows="10" cols="80" placeholder="{{ __('details french') }}">{{ isset($item) && $item->doctorInfo?->translate('fr') ? $item->doctorInfo->translate('fr')->details :'' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-2">

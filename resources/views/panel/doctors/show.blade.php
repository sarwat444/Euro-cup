                                        ...
                                        <div class="row custom_seperator">
                                            <div class="col-md-6 mb-3">
                                                <div class="ttl-info text-start">
                                                    <h6><i class="fa fa-envelope"></i> {{__('email')}}</h6><span>{{ $doctor->email }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="ttl-info text-start">
                                                    <h6><i class="fa fa-calendar"></i> {{__('created at')}}</h6><span>{{ date('d.m.y H:i', strtotime($doctor->created_at)) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="ttl-info">
                                                    <h6><i class="fa fa-envelope"></i> {{__('max price')}}</h6><span>{{ $doctor->doctorInfo?->max_price }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="ttl-info">
                                                    <h6><i class="fa fa-calendar"></i> {{__('min price')}}</h6><span>{{ $doctor->doctorInfo?->min_price }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12 col-lg-4 order-sm-0 order-xl-1">
                                    ...
                                    <div class="user-designation">
                                        <div class="user-image">
                                            <div class="avatar">
                                                @if(file_exists(public_path(config('constants.asset_path') . 'uploads/doctors/' . $doctor->image)))
                                                    <img alt="" src="{{ asset(config('constants.asset_path') . 'uploads/doctors/' . $doctor->image) }}">
                                                @else
                                        ...
                                        <div class="desc">({{ $doctor->doctorInfo?->specializeion->name }})</div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4 order-sm-2 order-xl-2">
                                    <div class="row">
                                        <div class="row custom_seperator">
                                            <div class="col-md-6 mb-3">
                                                <div class="ttl-info text-start">
                                                    <h6><i class="fa fa-phone"></i> {{ __('phone') }}</h6><span>{{ $doctor->mobile }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <div class="ttl-info text-start">
                                                    <h6><i class="fa fa-location-arrow"></i> {{ __('address') }}</h6><span>{{ $doctor->city . ' ' . $doctor->country?->name }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="ttl-info">
                                                    <h6><i class="fa fa-phone"></i> {{ __('appointment examination') }}</h6><span>{{ $doctor->doctorInfo?->appointment_examination_reply_time }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="ttl-info">
                                                    <h6><i class="fa fa-location-arrow"></i> {{ __('urgent amount') }}</h6><span>{{ $doctor->doctorInfo?->urgent_amount }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

            ...
            <div class="col-sm-12">
                <div class="card mt-4">
                    <div class="card-header pb-0 card-no-border">
                        <a class="btn btn-primary pull-right" href="{{route('panel.doctors.create.index')}}">
...
@push('panel_js')
    @include('panel.doctors.partials.scripts')
    @include('panel.doctors.partials.scripts.custom')
@endpush

                                ...
                                <div class="doctor-widget2">
                                    <div class="doc-info-left">
                                        <div class="doc-info-cont">
                                            <h4 class="doc-name"><a href="{{route('alternative-medicine.doctor_details' , $doctor->id )}}">{{$doctor->first_name}} {{$doctor->last_name}}</a></h4>
                                            <div class="clinic-details">
                                                <p class="doc-location"><i class="fas fa-map-marker-alt"></i> {{$doctor->doctorInfo->address}}</p>
                                                <p class="doc-location"><i class="far fa-clock"></i> {{__('front.After')}}  {{ $doctor->doctorInfo->alternative_medicine_price }} {{__('front.Hours')}}</p>
                                                <p class="doc-location"> <i class="far fa-money-bill-alt"></i> $  {{$doctor->doctorInfo->alternative_medicine_price}} </p>
                                    ...
                                    <div class="doc-info-right">
                                        ...
                                        <div class="clinic-booking">
                                            <a class="view-pro-btn" href="{{route('alternative-medicine.doctor_details' , $doctor->id )}}"> {{__('front.View Profile')}} </a>
                                        </div>
                                    </div>
                                </div>
                            </div>

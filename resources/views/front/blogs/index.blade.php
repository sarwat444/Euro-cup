            ...
            <div class="col-md-12">
                <ul class="nav nav-tabs custom_tabs" id="myTab" role="tablist">
                    <li class="nav-item me-2">
                        <a style="background-color: #19B9B7; border:1px solid #19B9B7" href="{{ route('blogs') }}" class="btn btn-primary active">{{__('front.Medical topics')}}</a>
                    </li>
                    <li class="nav-item me-2">
                        <a href="{{ route('blogQuestions') }}" class="btn btn-primary not-active">{{__('front.medical questions')}}</a>
                    </li>
                    <li class="nav-item me-2">
                        <a href="{{ route('public_blogQuestions') }}" class="btn btn-primary not-active">{{__('front.Public Questions')}}</a>
                    </li>
                </ul>
            </div>
        </div>

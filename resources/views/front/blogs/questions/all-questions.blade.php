        ...
        <div class="container">
            <div class="row align-items-center inner-banner">
                <div class="col-md-12 col-12 text-center">
                    <h2 class="breadcrumb-title">{{__('front.Public Questions')}} </h2>
                    <nav aria-label="breadcrumb" class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">{{__('front.home')}}</a></li>
                            <li class="breadcrumb-item" aria-current="page">{{__('front.Public Questions')}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <ul class="nav nav-tabs custom_tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item me-2">
                        <a  href="{{ route('blogQuestions') }}" class="btn btn-primary not-active ">{{__('front.medical questions')}}</a>
                    </li>
                    <li class="nav-item me-2">
                        <a style="background-color: #19B9B7; border:1px solid #19B9B7" href="{{ route('blog_public_questions') }}" class="btn btn-primary active ">{{__('front.Public Questions')}}</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="question-tabs mb-50px">
                            <div class="row">
                                ...
                                @endif
                                <div class="col-md-2">
                                    <a href="{{route('create_public_blogquestion')}}" class="btn btn-primary mb-2 add-quetion">{{__('front.Add New Quetion')}} </a>
                                </div>
                            </div>

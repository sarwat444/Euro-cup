                    ...
                    <div class="card card-item">
                        <form id="questionForm" action="{{ route('questions.store') }}" method="post" class="card-body">
                            ...
                            <div class="input-box mb-4">
                                <label class="font-size-14 text-black fw-medium mb-0">{{__('front.Special')}}</label>
                                <div class="form-group">
                                    <select class="form-control" name="category_id" required>
                                        <option selected disabled>{{ __('front.Select Category') }}</option>
            ...
            $('#questionForm').submit(function (event) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        window.location.href = '{{ route('blogQuestions') }}';
                    },

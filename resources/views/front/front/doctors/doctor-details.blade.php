        ...
        <script>
            $(document).ready(function() {
                ...
                $('.yes_btn').on('click', function(event) {
                    ...
                    $('.choosen_status').html("<div class='alert alert-primary urgent_message '>  You Have chosen Urgent detection You will pay an additional <span class='text-danger'>{{$doctor->doctorInfo->urgent_amount}} % </span>    <i class='icofont-undo undo_btn rendo_btn'> </div>");
                    $('#urgent').val(1)  ;
                });

        ...
        <div class="container">
            <div class="row align-items-center inner-banner">
                <div class="col-md-12 col-12 text-center">
                    <h2 class="breadcrumb-title">{{__('front.Questions')}} </h2>
        ...
        <div class="row mt-3">
            <div class="col-md-12">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <a href="{{ route('blogs') }}" class="btn btn-primary not-active">{{ __('front.blogs') }}</a>
                    </li>
                    <li class="nav-item me-2">
                        <a href="{{ route('questions.index') }}" class="btn btn-primary ">{{ __('front.Questions') }}</a>
                    </li>
                </ul>
            </div>
        </div>
                    ...
                    <div class="sidebar">
                        <div class="card border-0">
                            <ul class="generic-list-item generic-list-item-highlight fs-15">
                                <li class="lh-26 active"><a href="{{route('questions.index')}}"><i
                                                class="la la-home mr-1 text-black"></i><span
                                                class="badge badge-primary">{{$Questions->total()}}</span> {{__('front.All')}}</a></li>
                                @forelse($Categories as $Category)
                                    <li class="lh-26"><a href="{{route('questionCategory' , $Category->id )}}"><i
                                                    class="la la-home mr-1 text-black"></i> <span

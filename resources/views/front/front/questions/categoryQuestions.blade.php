                    ...
                    <div class="sidebar">
                        <div class="card border-0">
                            ...
                            <ul class="generic-list-item generic-list-item-highlight fs-15">
                                <li class="lh-26 "><a href="{{route('questions.index')}}"><i
                                            class="la la-home mr-1 text-black"></i><span
                                            class="badge badge-primary">{{$allCount}}</span>{{__('front.All')}} </a></li>
                                        @forelse($Categories as $Category)
                                            <li class="lh-26 @if($selected_category->id  == $Category->id ) active @endif"><a href="{{route('questionCategory' , $Category->id )}}"><i
                                                        class="la la-home mr-1 text-black"></i> <span

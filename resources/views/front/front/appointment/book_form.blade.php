...
@section('content')
    ...
    <div class="container-fluid full-height form-wizered">
        <div class="content-right" id="start">
            <h1 class="text-center main-title">{{__('front.Medical Report')}}</h1>
            <p class="text-center sub-title">{{__('front.Fill This Survey To make appointment')}}</p>
            <p></p>
            <div id="wizard_container" class="my-auto">
                ...
                <form id="wrapped" method="POST" action="{{route('save_appointment')}}" enctype="multipart/form-data">
                    ...
                    <div id="middle-wizard">
                        <div class="step">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group female_status d-none">
                                                    <select name="breastfeeding_status" class="form-control">
                                                        ...
                                                        <option value="breastfeeding" >{{__('front.No pregnancy')}}</option>
                                                        <option value="not_breastfeeding">{{__('front.Breastfeeding')}}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="weight" class="form-control required" placeholder="70">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{__('front.height')}}</label>
                                        <input type="number" name="height" class="form-control required" placeholder="110">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="country" class="form-control required" placeholder="{{__('front.Ex , Syria')}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{__('front.Nationality')}}</label>
                                        <input type="text" name="nationality" class="form-control required" placeholder="{{__('front.Ex , Syrian')}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone_number" class="form-control required" placeholder="012********">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="work" class="form-control required" placeholder="{{__('front.engineer')}}">
                                    </div>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group radio_input">
                                        <label class="container_radio">{{__('front.Yes')}}
                                            <input type="radio" name="had_hereditary_diseases" value="1" class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio">{{__('front.No')}}
                                            <input type="radio" name="had_hereditary_diseases" value="0" class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <textarea style="min-height: 145px" class="form-control" name="hereditary_diseases_names"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group radio_input">
                                        <label class="container_radio">{{__('front.Yes')}}
                                            <input type="radio" name="take_medications_regularly" value="1" class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                        <label class="container_radio">{{__('front.No')}}
                                            <input type="radio" name="take_medications_regularly" value="0" class="required">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                            ...
                            <div class="form-group terms">
                                <label class="container_check">{{__('front.Please accept our')}} <a href="#"
                                                                                                    data-bs-toggle="modal"
                                                                                                    data-bs-target="#terms-txt">{{__('front.Terms and conditions')}} </a>
                                    <input type="checkbox" name="terms" value="Yes" class="required">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                        ...
                        <div class="step">
                            ...
                            <div class="col-md-6">
                                <div class="hero">
                                    <div class="music">
                                        <label class="mb-3">{{__('front.Download an audio clip of your complaint or a live recording')}}   </label>
                                        <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="track2">
                                                        ...
                                                        <span class="text-danger" id="delete_btn2" style="display: none;">  <i
                                                                class="icofont-close-circled"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="submit step">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <div class="upload-btn">
                                                    <label class="mb-3"> {{__('front.Upload your files for your tests medical')}}</label>
                                                    <div class="upload__box">
                                                        <div class="upload__btn-box">
                                                            <label class="upload__btn">
                                                                <p> {{__('front.Upload images & Files')}} </p>
                                                                <input name="test_medical_attachment[]" type="file" multiple=""
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label class="mb-3"> {{__('front.Upload your video for your CD with reports')}} </label>
                                                <div class="upload__box">
                                                    <div class="upload__btn-box">
                                                        <label class="upload__btn">
                                                            <p>{{__('front.Upload Reports')}}</p>
                                                            <input name="cd_reports_video" type="file" multiple="" data-max_length="20"
                                                                   class="upload__inputfile1 upload__inputfile" accept="video/*">
                                                        </label>
                                                    </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label class="mb-3">{{__('front.Write the tests and medications you are taking')}} <span class="text-danger">*</span>
                                    </label>
                    ...
                    <div id="bottom-wizard">
                        ...
                        <button id="submit-btn" type="button" name="process" class="submit">{{__('front.Save')}}</button>
                        <button type="button" name="forward" class="forward continue_whatsapp" onclick="window.open('https://api.whatsapp.com/send?phone=01212414991', '_blank')">
                            <i class="icofont-whatsapp"></i> Continue With Whatsapp
                        </button>
                    </div>
                </form>
            </div>
...
@push('scripts')
    ...
    <script>
        /** Uploading Videos Function preview */
        ...
        function getFileIconClass(extension) {
            ...
            switch (extension) {
                ...
                // Add more cases for other video types
                default:
                    return 'fa fa-file';
            }
        }

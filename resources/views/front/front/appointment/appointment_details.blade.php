                         ...
                         <div class="row ">
                                <div class="col-md-12">
                                    <p> <span class="answer text-info"> {{__('front.medical complaint')}} : </span>
                                         {{$appointment->notes}}  </span></p>
                                </div>
                          </div>
                        <!--Recoding Voice -->
                        @if(!empty($appointment->attachments2->voice))
...
@push('scripts')
    ...
    <script>
        $(document).ready(function () {
            ...
            var audioUrl2 = '{{ asset(config('constants.asset_path').'uploads/appointments/'.$appointment->id.'/audio/'.$appointment->attachments2->medications_voice) }}';

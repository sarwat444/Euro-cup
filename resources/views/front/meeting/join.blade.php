...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="{{asset(config('constants.asset_path').'assets/front/agora/css/main.css')}}">
...
<body>
    ...
    @endif
    <input type="text" id="linkUrl" value="{{url('admin/appointments/meeting/join/')}}/{{$meeting->url}}">
    ...
    <div id="stream-wrapper" style="height: 100%; display:block">
        ...
        <div id="stream-controls">
            ...
            <button id="rec-btn">Recording</button>

        </div>
    </div>
    <input id="appid" type="hidden" value="{{$meeting->appCertificate}}" readonly>
...
<script src="{{asset(config('constants.asset_path').'assets/front/agora/js/AgoraRTC_N-4.7.3.js')}}" ></script>
<script src="{{asset(config('constants.asset_path').'assets/front/agora/js/main.js')}}" ></script>
<script src="https://js.pusher.com/7.2/pusher.min.js"></script>
  <script>
    ...
    var pusher = new Pusher('12916770f01fe868b18d', {
      cluster: 'mt1',
      encrypted: true
    });

...
<script src="{{asset(config('constants.asset_path').'assets/front/js/jquery.min.js')}}"></script>
    ...
    <script  src="{{asset(config('constants.asset_path').'assets/front/js/meeting.js')}}" ></script>
    </head>
            ...
            <div id="waitingArea" class="max-h-screen">
                ...
                <div class="max-w-2xl  flex flex-col space-y-4 ">
                    ...
                    <div class="flex space-x-4 mb-4 justify-center">
                        ...
                        <button id='waitingAreaToggleMicrophone' class="bg-gray-400 w-10 h-10 rounded-md p-2 icon">
                        ...
                        <button id='waitingAreaToggleCamera' class="bg-gray-400 w-10 h-10 rounded-md p-2 icon">

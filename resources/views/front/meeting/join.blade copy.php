...
<head>
  ...
  <link rel="stylesheet" href="{{asset(config('constants.asset_path').'assets/front/agora/css/bootstrap.min.css')}}">
  <link rel="stylesheet" href="{{asset(config('constants.asset_path').'assets/front/agora/css/index.css')}}">
</head>
<body>
  ...
  <script src="{{asset(config('constants.asset_path').'assets/front/agora/js/jquery-3.4.1.min.js')}}"></script>
  <script src="{{asset(config('constants.asset_path').'assets/front/agora/js/bootstrap.bundle.min.js')}}"></script>
  <script src="{{asset(config('constants.asset_path').'assets/front/agora/js/AgoraRTC_N-4.20.2.js')}}"></script>
  <script src="{{asset(config('constants.asset_path').'assets/front/agora/js/index.js')}}"></script>
</body>
</html>
